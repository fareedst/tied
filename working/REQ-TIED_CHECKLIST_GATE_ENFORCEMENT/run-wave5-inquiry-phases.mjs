#!/usr/bin/env node
/**
 * [REQ-TIED_CHECKLIST_GATE_ENFORCEMENT] Wave 5 close-out: verification + close_out inquiry.
 */
...
const SOURCE_REVISION = "wave5-process-adherence-closeout-20260910";

const PHASES = [
  { phase: "verification", run_id: "wave5-verify-20260910" },
  { phase: "close_out", run_id: "wave5-closeout-20260910" },
];
...
function buildModeAPayload(phase, runId, blockId) {
  const stdout = execFileSync(
    ...
    [
      ...
      "--test-path",
      "tools/agentstream/checklist/process_grade_test.go",
      "--production-path",
...
async function main() {
  ...
  fs.writeFileSync(
    path.join(REPO, "working", REQ, "evidence", "wave5-inquiry-phases-result.json"),
