#!/usr/bin/env node
/**
 * NB-3-E: client verification + close_out gates (minimal depth; mirrors NB-1-E).
...
const RUN_ID = "nb3-tranche-two-closeout-20260913";

const CLIENTS = [
  {
    client_id: "1787495576",
    repo: "/Users/fareed/Documents/dev/test/1787495576",
    req: "REQ-PSEUDOCODE_MIGRATION",
    wave_id: "W-ext-1787495576-1",
    g3_summary: "working/fleet-constraint-v2/waves/1787495576/receipts/summary.json",
    impl_tokens: ["IMPL-NETIF_CLI", "IMPL-NETIF_DISCOVERY", "IMPL-NETIF_FORMAT"],
  },
  {
    client_id: "1787603099",
    repo: "/Users/fareed/Documents/dev/test/1787603099",
    req: "REQ-PSEUDOCODE_MIGRATION",
    wave_id: "W-ext-1787603099-1",
    g3_summary: "working/fleet-constraint-v2/waves/1787603099/receipts/summary.json",
    impl_tokens: [
      "IMPL-LISTENING_PORT_CLI_MAIN",
      "IMPL-LISTENING_PORT_COLLECT",
      "IMPL-LISTENING_PORT_JSON",
    ],
  },
  {
    client_id: "1787416567",
    repo: "/Users/fareed/Documents/dev/test/1787416567",
    req: "REQ-PSEUDOCODE_MIGRATION",
    wave_id: "W-ext-1787416567-1",
    g3_summary: "working/fleet-constraint-v2/waves/1787416567/receipts/summary.json",
    impl_tokens: [
      "IMPL-VOLUMESTATS-CLI",
      "IMPL-VOLUMESTATS-DISCOVER",
      "IMPL-VOLUMESTATS-REPORT",
      "IMPL-VOLUMESTATS-STATS",
    ],
  },
  {
    client_id: "1787507684",
    repo: "/Users/fareed/Documents/dev/test/1787507684",
    req: "REQ-PSEUDOCODE_MIGRATION",
    wave_id: "W-ext-1787507684-1",
    g3_summary: "working/fleet-constraint-v2/waves/1787507684/receipts/summary.json",
    impl_tokens: [
      "IMPL-ROOTJOBS_CLI",
      "IMPL-ROOTJOBS_COLLECT",
      "IMPL-ROOTJOBS_RENDER",
      "IMPL-ROOTJOBS_TREE",
    ],
  },
  {
    client_id: "1787638699",
    repo: "/Users/fareed/Documents/dev/test/1787638699",
    req: "REQ-PSEUDOCODE_MIGRATION",
    wave_id: "W-ext-1787638699-1",
    g3_summary: "working/fleet-constraint-v2/waves/1787638699/receipts/summary.json",
    impl_tokens: [
      "IMPL-WININFO_CLI",
      "IMPL-WININFO_ENUMERATE",
      "IMPL-WININFO_FILTER",
      "IMPL-WININFO_RENDER",
    ],
  },
  ...
  const body = {
    [client.req]: {
      change_definition: {
        ...
        desired_behavior:
          "Wave sidecars constraint-enforced-v2 with G3 receipts (NB-3 tranche two)",
      ...
      risk_analysis: {
        adversarial_inquiry: {
          ...
          close_out_inquiry_waiver:
            "NB-3 fleet pseudo-code migration only; integrated inquiry not required.",
          rationale: "Minimal depth client migration close-out.",
        },
      },
      completion_criteria: {
        verification_gate_notes: `NB-3 orchestrator G3 summary ${client.g3_summary}`,
      },
    },
  };
...
function writeChecklist(client) {
  ...
  const checklist = {
    copy_hygiene: `NB-3 client migration close-out for ${client.client_id}`,
    request: client.req,
    ...
    steps: [
      {
        ...
        rationale:
          "NB-3 client migration is minimal depth with close_out_inquiry_waiver; no integrated inquiry run.",
      },
      {
...
mkdirSync(join(STDD, "working/fleet-constraint-v2/NB-3/evidence"), { recursive: true });
writeFileSync(
  join(STDD, "working/fleet-constraint-v2/NB-3/evidence/nb3-client-closeout-summary.json"),
