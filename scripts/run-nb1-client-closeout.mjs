#!/usr/bin/env node
/**
 * NB-1-E: client verification + close_out gates (minimal depth; mirrors Phase 4 E2.4).
...
const RUN_ID = "nb1-tranche-zero-closeout-20260913";

const CLIENTS = [
  {
    client_id: "1786636023",
    repo: "/Users/fareed/Documents/dev/test/1786636023",
    req: "REQ-PSEUDOCODE_MIGRATION",
    wave_id: "W-ext-1786636023-1",
    g3_summary: "working/fleet-constraint-v2/waves/1786636023/receipts/summary.json",
    impl_tokens: ["IMPL-PRIME_PRINTER"],
  },
  {
    client_id: "1786637086",
    repo: "/Users/fareed/Documents/dev/test/1786637086",
    req: "REQ-PSEUDOCODE_MIGRATION",
    wave_id: "W-ext-1786637086-1",
    g3_summary: "working/fleet-constraint-v2/waves/1786637086/receipts/summary.json",
    impl_tokens: ["IMPL-FIRST_FIVE_PRIMES"],
  },
  {
    client_id: "1786666674",
    repo: "/Users/fareed/Documents/dev/test/1786666674",
    req: "REQ-PSEUDOCODE_MIGRATION",
    wave_id: "W-ext-1786666674-1",
    g3_summary: "working/fleet-constraint-v2/waves/1786666674/receipts/summary.json",
    impl_tokens: ["IMPL-SORT_THREE_INTEGERS"],
  },
  {
    client_id: "1787503424",
    repo: "/Users/fareed/Documents/dev/test/1787503424",
    req: "REQ-PSEUDOCODE_MIGRATION",
    wave_id: "W-ext-1787503424-1",
    g3_summary: "working/fleet-constraint-v2/waves/1787503424/receipts/summary.json",
    impl_tokens: ["IMPL-DESKTOP_WINDOW_REPORT"],
  },
  {
    client_id: "1789087315",
    repo: "/Users/fareed/Documents/dev/test/1789087315",
    req: "REQ-PSEUDOCODE_MIGRATION",
    wave_id: "W-ext-1789087315-1",
    g3_summary: "working/fleet-constraint-v2/waves/1789087315/receipts/summary.json",
    impl_tokens: ["IMPL-DUPCOMPARE"],
  },
];
  ...
  const body = {
    [client.req]: {
      change_definition: {
        ...
        desired_behavior:
          "Wave sidecars constraint-enforced-v2 with G3 receipts (NB-1 tranche zero)",
      ...
      risk_analysis: {
        adversarial_inquiry: {
          ...
          close_out_inquiry_waiver:
            "NB-1 fleet pseudo-code migration only; integrated inquiry not required.",
          rationale: "Minimal depth client migration close-out.",
        },
      },
      completion_criteria: {
        verification_gate_notes: `NB-1 orchestrator G3 summary ${client.g3_summary}`,
      },
    },
  };
...
function writeChecklist(client) {
  ...
  const checklist = {
    copy_hygiene: `NB-1 client migration close-out for ${client.client_id}`,
    request: client.req,
    ...
    steps: [
      {
        ...
        rationale:
          "NB-1 client migration is minimal depth with close_out_inquiry_waiver; no integrated inquiry run.",
      },
      {
...
mkdirSync(join(STDD, "working/fleet-constraint-v2/NB-1/evidence"), { recursive: true });
writeFileSync(
  join(STDD, "working/fleet-constraint-v2/NB-1/evidence/nb1-client-closeout-summary.json"),
