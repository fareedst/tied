#!/usr/bin/env python3
"""NB-2-C: spawn client-owned REQ-PSEUDOCODE_MIGRATION stack (NB-2 tranche one)."""
...
CLIENTS: dict[str, list[str]] = {
    "1786637885": ["IMPL-FIRST_N_PRIMES", "IMPL-PRINT_FIRST_FIVE_PRIMES"],
    "1786643714": ["IMPL-FIBONACCI_CLI", "IMPL-FIBONACCI_GENERATE_SEQUENCE"],
    "1788547701": ["IMPL-BT_CLI_FORMATTER", "IMPL-BT_DARWIN_COLLECTOR"],
    "1787421852": [
...
def spawn_client(client_id: str, impl_tokens: list[str]) -> None:
        ...
        yaml.dump(
            {
                "REQ-PSEUDOCODE_MIGRATION": {
                    "category": "Functional",
                    "description": f"NB-2 Track B tranche one; wave {wid}.",
        ...
        yaml.dump(
            {
                "ARCH-PSEUDOCODE_MIGRATION": {
                    ...
                    "decision": "Client defers to orchestrator fleet program; local REQ records proof boundary for NB-2 G3 wave.",
        ...
        yaml.dump(
            {
                "CITDP-REQ-PSEUDOCODE_MIGRATION": {
                    "change_definition": {
                        "current_behavior": "Sidecar header-only-v2 before NB-2 G3 enforce",
                    ...
                    "risk_analysis": {
                        "adversarial_inquiry": {
                            ...
                            "rationale": "NB-2 fleet pseudo-code migration close-out.",
                        }
                    },
                }
            },
    ...
    ensure_index_entry(
        ...
        {
            "category": "Functional",
            "description": f"NB-2 fleet migration evidence for client {client_id} wave {wid}.",
    ...
    print(f"TRACE: NB-2-C spawned {client_id} {impl_tokens}")
