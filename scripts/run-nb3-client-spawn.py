#!/usr/bin/env python3
"""NB-3-C: spawn client-owned REQ-PSEUDOCODE_MIGRATION stack (NB-3 tranche two)."""
...
CLIENTS: dict[str, list[str]] = {
    "1787495576": ["IMPL-NETIF_CLI", "IMPL-NETIF_DISCOVERY", "IMPL-NETIF_FORMAT"],
    "1787603099": [
...
def spawn_client(client_id: str, impl_tokens: list[str]) -> None:
        ...
        yaml.dump(
            {
                "REQ-PSEUDOCODE_MIGRATION": {
                    "category": "Functional",
                    "description": f"NB-3 Track B tranche two; wave {wid}.",
        ...
        yaml.dump(
            {
                "ARCH-PSEUDOCODE_MIGRATION": {
                    ...
                    "decision": "Client defers to orchestrator fleet program; local REQ records proof boundary for NB-3 G3 wave.",
        ...
        yaml.dump(
            {
                "CITDP-REQ-PSEUDOCODE_MIGRATION": {
                    "change_definition": {
                        "current_behavior": "Sidecar header-only-v2 before NB-3 G3 enforce",
                    ...
                    "risk_analysis": {
                        "adversarial_inquiry": {
                            ...
                            "rationale": "NB-3 fleet pseudo-code migration close-out.",
                        }
                    },
                }
            },
    ...
    ensure_index_entry(
        ...
        {
            "category": "Functional",
            "description": f"NB-3 fleet migration evidence for client {client_id} wave {wid}.",
    ...
    print(f"TRACE: NB-3-C spawned {client_id} {impl_tokens}")
