...
## 1. STDD Structure [ARCH-STDD_STRUCTURE] [REQ-STDD_SETUP]
(50+ lines of content)
...
|-------|-------|--------|------------------|-------------|
| `[ARCH-STDD_STRUCTURE]` | STDD Structure | Active | [REQ-STDD_SETUP] | [Detail](architecture-decisions/ARCH-STDD_STRUCTURE.md) |
