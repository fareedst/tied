# Refine (Touchpoint 1 — RESOLVE) — non-TIED
...
**Note:** In `non-tied-*` workflows, vocabulary **reads** are allowed for domain understanding. Do **not** RECORD vocabulary synchronization artifacts — see [non-tied-boundary.md](non-tied-boundary.md).
