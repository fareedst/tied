...
**Gate:** Do not start code until IMPL pseudo-code (with block token comments)
and test strategy are in place and `tied_checklist_gate_validate` allows the
`pre_implementation` phase for the Tracker/CITDP.
