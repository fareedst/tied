...
- **Unified checklist**: `docs/agent-req-implementation-checklist.md` (`[PROC-AGENT_REQ_CHECKLIST]`) — the step-by-step procedure that sequences this mandatory order with CITDP, LEAP, and validation.
