...
- Guide documents at `tied/` root: `requirements.md`, `architecture-decisions.md`, `implementation-decisions.md`, `processes.md`, `semantic-tokens.md`, etc. Reference docs under `tied/docs/` (including `commit-guidelines.md`) are copied from this repo’s `docs/` by `copy_files.sh`.
