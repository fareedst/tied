...
**Start at session-bootstrap** (Session Bootstrap). Complete session-bootstrap as in the main checklist (read `ai-principles.md`, review semantic tokens, architecture and implementation indexes, implementation-decisions guide, confirm MCP and priority order).
