...
6. **Detail field shapes** (e.g. `description`): prefer [detail-files-schema.md](../tied/detail-files-schema.md) over partial samples.
...
| Topic | Document |
|--------|----------|
| REQ / ARCH / IMPL detail YAML shapes | [detail-files-schema.md](../tied/detail-files-schema.md) |
| Server behavior and tool schemas | [mcp-server/README.md](../mcp-server/README.md) |
| Without Node/MCP (documented manual path) | [using-tied-without-mcp.md](../tied/docs/using-tied-without-mcp.md) |
...
| Topic | Document |
|--------|----------|
| Token registry and guide | [`tied/semantic-tokens.yaml`](../tied/semantic-tokens.yaml), [`tied/semantic-tokens.md`](../tied/semantic-tokens.md) |
| IMPL pseudo-code and `[PROC-IMPL_PSEUDOCODE_TOKENS]` | [`tied/implementation-decisions.md`](../tied/implementation-decisions.md) |
