...
procedure REFRESH_BOOTSTRAP_VOCABULARY(projectRoot, mergeVocab):
  ...
  Contract:
    ...
    TERMINATION: total
  RUN REFRESH_VOCABULARY(projectRoot, mergeVocab) per IMPL-TIED_VOCABULARY_REFRESH sidecar contract
  RETURN success
...
procedure BOOTSTRAP_TIED_NODE(projectRoot, mergeVocab):
  ...
  RUN tools/bootstrap/lib/bootstrap.mjs orchestration using manifest lists
  RETURN success
