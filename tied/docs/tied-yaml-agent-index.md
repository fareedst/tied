...
| Topic | Document |
|--------|----------|
| Domain vocabulary (**PRELOAD** before reading TIED/resources) | Client handoff [`tied/vocab/routing.md`](../vocab/routing.md) → methodology route [`tied/methodology/vocab/routing.md`](../methodology/vocab/routing.md), then matched glossaries; standards [`tied/docs/vocabulary-index-analysis-and-standards.md`](vocabulary-index-analysis-and-standards.md); matching full catalogs on-demand |
