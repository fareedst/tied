...
Files live at `tied/vocab/<topic>.md`. The index [`../vocab/domain-references.md`](../vocab/domain-references.md) lists every glossary and **cross-topic** notes—short relation graphs for features that span modules. When that full index grows large, agents bootstrap from [`../vocab/domain-references-routing.md`](../vocab/domain-references-routing.md) (~70 lines) and PRELOAD only matched glossaries.
...
1. Open [`../vocab/domain-references-routing.md`](../vocab/domain-references-routing.md).
