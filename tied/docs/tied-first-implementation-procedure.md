...
| [pseudocode-writing-and-validation.md](pseudocode-writing-and-validation.md) | Three-way alignment, phases A–I, LEAP (stub: [impl-code-test-linkage.md](impl-code-test-linkage.md)) |
