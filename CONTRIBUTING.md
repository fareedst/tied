...
- Align with **[PROC-TIED_DEV_CYCLE](tied/docs/processes.md)** and **[PROC-NEW_FEATURE](tied/docs/new-feature-process.md)**: one session commit after README/CHANGELOG and TIED doc updates.
...
- Add [PROC-NEW_FEATURE] to tied/docs/processes.md and semantic-tokens.yaml
