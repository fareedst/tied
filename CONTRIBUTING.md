...
Commit message format and release process are defined in **tied/processes.md**: see [PROC-COMMIT_MESSAGES](tied/processes.md) and [PROC-RELEASE](tied/processes.md).
...
- Full format, types, scopes, and examples: **tied/processes.md** § [PROC-COMMIT_MESSAGES]. Release versioning: § [PROC-RELEASE].
- Align with **[PROC-TIED_DEV_CYCLE](tied/processes.md)** and **[PROC-NEW_FEATURE](tied/docs/new-feature-process.md)**: one session commit after README/CHANGELOG and TIED doc updates.
...
- Add tied/docs/new-feature-process.md with flow diagram and procedure
